...
insert into Course values(1, "Software Engineering Fundamentals", "It is a course specially designed for professionals", "To learn the MEDEPA methodology", 3, "2023-03-14", "18:00:00", "2023-01-13", "2023-02-26", 50,50, 700, "Oviedo. COIIPA", "Active", 1, 1500);
insert into Course values(2, "MBA", "Business administration master", "To learn how to deal with money", 7, "2021-07-23", "12:00:00", "2021-05-23", "2021-06-29", 75,75,350, "Oviedo. Informatics School", "Cancelled", 2, 1000);
insert into Course values(3, "Azure Cloud certifications", "A one-day formative action oriented to cloud developers", "To learn a new fixture introduced by Microsoft in its Azure servers", 5, "2023-04-12", "13:00:00", "2023-02-23", "2023-03-23", 50,2, 500, "Oviedo. COIIPA", "Active", 3, 2300);

-- Insert 5 random entries into Course table
INSERT INTO Course (course_id, course_name, description, objectives, course_hours, course_date, course_time, course_start_period, course_end_period, total_places, available_places, course_fee, place, course_state, teacher_id, teacher_remuneration)
VALUES 
  (4, 'English Conversation', 'Improve your spoken English with this course.', 'By the end of the course, students will be able to engage in conversations on various topics.', 20, '2023-12-01', '10:00:00', '2023-04-01', '2023-05-01', 20, 10, 100, 'Online', 'Active', 1, 2000),
  (5, 'Introduction to Python', 'Learn the basics of Python programming language.', 'By the end of the course, students will be able to write simple programs using Python.', 30, '2023-12-01', '14:00:00', '2023-05-01', '2023-06-01', 30, 20, 150, 'Classroom A', 'Active', 2, 3000),
  (6, 'Digital Marketing', 'Learn the basics of digital marketing strategies and tools.', 'By the end of the course, students will be able to develop a digital marketing plan for a business.', 25, '2023-12-01', '16:00:00', '2023-06-01', '2023-07-01', 25, 15, 200, 'Online', 'Active', 3, 4000),
  (7, 'Spanish for Beginners', 'Learn the basics of the Spanish language.', 'By the end of the course, students will be able to introduce themselves and hold simple conversations in Spanish.', 40, '2023-12-01', '18:00:00', '2023-07-01', '2023-08-01', 40, 30, 120, 'Classroom B', 'Active', 2, 2500),
  (8, 'Data Analysis with Excel', 'Learn how to use Excel to analyze and visualize data.', 'By the end of the course, students will be able to use various Excel tools and functions to analyze and present data.', 20, '2023-10-01', '10:00:00', '2023-08-01', '2023-09-01', 20, 10, 100, 'Classroom C', 'Active', 3, 2000);
...
INSERT INTO Course (course_id, course_name, description, objectives, course_hours, course_date, course_time, course_start_period, course_end_period, total_places, available_places, course_fee, place, course_state, teacher_id, teacher_remuneration)
VALUES 
  (9, 'Mobile App Development with React Native', 'Learn to build mobile apps with React Native', 'Develop mobile app development skills', 60, '2023-8-01', '18:00:00', '2023-07-01', '2023-08-01', 10, 5, 250, 'In-person', 'Active', 4, 1500),
  (10, 'Database Design with MySQL', 'Learn how to design and create databases using MySQL', 'Learn how to design and implement databases, and how to use SQL to manage data', 30, '2023-12-01', '12:00:00', '2023-09-01', '2023-10-31', 20, 20, 150, 'Online', 'Active', 1, 2000);
...
INSERT INTO Teacher (teacher_id, teacher_name, teacher_surnames, teacher_phone, teacher_email)
VALUES
(1000, 'John', 'Doe', '123456789', 'john.doe@example.com'),
(1001, 'Jane', 'Doe', '987654321', 'jane.doe@example.com'),
(1002, 'Bob', 'Smith', '555555555', 'bob.smith@example.com');

-- Insert courses
INSERT INTO Course (course_id, course_name, description, objectives, course_hours, course_date, course_time, course_start_period, course_end_period, total_places, available_places, course_fee, place, course_state, teacher_id, teacher_remuneration)
VALUES
(1000, 'Introduction to Programming', 'An introduction to computer programming', 'To learn programming basics', 60, '2023-12-01', '09:00:00', '2023-04-01', '2023-06-01', 20, 20, 1000, 'Online', 'Active', 1000, 500),
(1001, 'Advanced Programming', 'A course on advanced programming concepts', 'To learn advanced programming techniques', 60, '2023-12-01', '09:00:00', '2023-06-01', '2023-07-01', 15, 15, 1500, 'Onsite', 'Active', 1001, 750),
(1002, 'Web Development', 'A course on web development', 'To learn web development basics', 60, '2023-07-01', '09:00:00', '2023-03-01', '2023-06-01', 25, 25, 1200, 'Online', 'Active', 1002, 600);
